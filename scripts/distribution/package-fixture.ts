...
export const REQUIRED_PACKAGE_FILES = [
  ...
  'docs/map.md',
  'docs/reference.md',
  'schemas/reference-search-input.schema.json',
  ...
  'examples/clients/generic.json',
  'examples/probability/event-mtth-scenarios.json',
  'examples/probability/focus-route-scenarios.json',
  'examples/probability/adaptive-event-pool.json',
  'examples/probability/event-mtth-simulate-input.json',
  'examples/probability/focus-route-sweep-input.json',
  'examples/probability/adaptive-event-sequence-input.json',
  'schemas/probability-scenario-set.schema.json',
  'schemas/custom-weighted-pool.schema.json',
  'schemas/probability-inspect-input.schema.json',
  'schemas/probability-evaluate-input.schema.json',
  'schemas/probability-sweep-input.schema.json',
  'schemas/probability-simulate-input.schema.json',
  'schemas/probability-sequence-input.schema.json',
  'schemas/probability-compare-input.schema.json',
  'schemas/probability-render-input.schema.json',
  'schemas/probability-analysis-result.schema.json',
  'schemas/helper-expansion-request.schema.json',
  'schemas/helper-expansion-summary.schema.json',
