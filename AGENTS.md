...
HOI4 Agent Tools is a public Model Context Protocol server for coding agents that create and clean focus trees, scripted GUIs, and maps in external Hearts of Iron IV mods. The MCP server is the product surface; do not add a dashboard, interactive editor, or gameplay-tool CLI.
